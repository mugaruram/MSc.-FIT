// Youtube Video: https://www.youtube.com/watch?v=CnLqENvBnvE&t=4s
...
var initApp = function() {
  ...
  WIDGS.main.coefImage = uiUtils.makeTextPanel(
    'Segment Image',
    'users/mugarura_michael/classification_segments_TD1990_Ty1993',//users/mugarura_michael/classification_segments_1990-2020_RD
    'horizontal')
  ...
  .widgets()
  .get(1)
  .setPlaceholder('Water, Builtup, Grassland, Barren, Modified_Field, Riparian_Forests, Rocky_Mountains, Shrubs, Wetlands')
  ...
  .widgets()
  .get(1)
  .setPlaceholder('#0804ff, #ff1004, #03b819, #fbff08, #5a1b4f, #04ff0c, #727272, #033907, #08ffaf')
