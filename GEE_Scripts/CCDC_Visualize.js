...
//  • gee-ccdc-tools (Eric L. Bullock, Boston University) — Apache-2.0:
//    https://github.com/parevalo-bu/gee-ccdc-tools
//
// Thesis citation:
...
// youtube video: https://www.youtube.com/watch?v=xAkrE8b6sZ0&t=14s
/**
 * 
...
var initApp = function(){
  ...
  app.loader.coefImage = ui.Panel(
    [
      ...
      ui.Textbox({value:'users/mugarura_michael/ccdc_oo_Assets_90-22', style:{stretch: 'horizontal'}}) 
    ],
    ui.Panel.Layout.Flow('horizontal'),
    horizontalStyle
  );
