...
var startYear = 1990;
var endYear = 2000;
var startMonth = 6; //1 January wet or 6 June dry
var endMonth = 9;   // 3 March  wet  0r 9 september dry
...
print('Summer NDVI (1990–2000):', winterNDVI);
...
Map.addLayer(winterSlope, slopeVis, 'Dry NDVI Trend (Slope) 1990-2000');
Map.addLayer(winterOffset, offsetVis, 'Dry NDVI Trend (Offset) 1990-2000');


// Export Slope and Offset to Drive
Export.image.toDrive({
  image: winterSlope,
  description: 'DRY_NDVI_Trend_Slope_1990-2000',  //'Dry_NDVI_Trend_Slope_1990-2000',
  folder:'SI_RD', 
...
Export.image.toDrive({
  image: winterOffset,
  description: 'DRY_NDVI_Trend_Offset_1990-2000', // 'Dry_NDVI_Trend_Offset_1990-2000',
  folder:'SI_RD', 
  scale: 30,
  crs: 'EPSG:4326',
  region: tigrovayaBalka,
